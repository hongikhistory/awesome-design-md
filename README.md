...
- [**AI Bootcamp**](https://github.com/VoltAgent/awesome-design-md/tree/main/design-md/ai-bootcamp/) - AI study bootcamp. Figma-inspired monochrome interface with vibrant multi-color gradients
